const SLOT_LABELS: Record<string, string> = {
  ...
  'esg.energy.gas.bill': '가스 요금 고지서',
  'esg.energy.water.usage': '수도 사용량',
  'esg.energy.water.bill': '수도 요금 고지서',
  'esg.energy.electricity.bill': '전기 요금 고지서',
  'esg.energy.electricity.month_match': '전기 월별 사용량-고지서 교차검증',
  'esg.energy.gas.month_match': '가스 월별 사용량-고지서 교차검증',
  'esg.energy.water.month_match': '수도 월별 사용량-고지서 교차검증',
  'esg.energy.electricity.peak_2024_vs_2025': '전력 피크(2024 대비 2025) 교차검증',
  'esg.hazmat.inventory': '유해물질 목록',
  'esg.hazmat.msds': '물질안전보건자료(MSDS)',
  'esg.hazmat.disposal.list': '폐기물 처리 목록',
  'esg.hazmat.disposal.evidence': '폐기물 처리 증빙',
  'esg.hazmat.disposal.cross_check': '폐기물 목록-증빙 교차검증',
  'esg.hazmat.msds.coverage': '유해물질 목록-MSDS 교차검증',
  ...
  'esg.governance.pledge_check': '윤리강령 개정일-서약일 교차검증',
